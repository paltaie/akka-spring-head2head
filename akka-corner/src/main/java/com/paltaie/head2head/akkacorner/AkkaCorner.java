package com.paltaie.head2head.akkacorner;
...
public class AkkaCorner extends AllDirectives {
	
	private static final Logger LOG = LoggerFactory.getLogger(AkkaCorner.class);
